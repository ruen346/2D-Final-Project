...
class IdleState:
    ...
    def do(monster3):
        ...
        if monster3.move == 1:
            monster3.x += RUN_SPEED_PPS * game_framework.frame_time
        elif monster3.move == 2:
            monster3.y -= RUN_SPEED_PPS * game_framework.frame_time
        ...
        for game_object in game_world.all_objects():
            if str(game_object).find("shot_arrow") != -1: # shot_arrow와 충돌시
                if game_object.x > monster3.x - 64 and game_object.x < monster3.x + 64 and game_object.y < monster3.y + 64 and  game_object.y > monster3.y - 64:
                    ...
                    monster3.hp -= main_state.tower1_d + game_object.damage
                    break
                ...
                if game_object.x > monster3.x - 64 and game_object.x < monster3.x + 64 and game_object.y < monster3.y + 64 and  game_object.y > monster3.y - 64:
                    ...
                    fire = Fire(monster3.x, monster3.y, game_object.damage)
                ...
                if math.sqrt((game_object.x - monster3.x)**2 + (game_object.y - monster3.y)**2) < 100 and get_time() >= monster3.time + 0.1:
                    game_world.remove_object(game_object)
                    monster3.hp -= main_state.tower3_d + game_object.damage
                    break
    ...
    def draw(monster3):
        ...
        monster3.hp_red.clip_draw(2, 2, int(60 * monster3.hp / 250), 12, monster3.x + main_state.elf_move_window_x, monster3.y + main_state.elf_move_window_y + 70)
